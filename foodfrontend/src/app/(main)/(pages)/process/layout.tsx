...
export const metadata: Metadata = {
  ...
  description:
    'Discover how Highland Yakchew crafts premium yak milk dog chews. From Himalayan milk procurement to the final product – a natural, authentic process.',
  alternates: {
    canonical: 'https://highlanddogchew.co.uk/process',
  },
  openGraph: {
    title: 'How We Make Our Yak Chews | Highland Yakchew Process',
