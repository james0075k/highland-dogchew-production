...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Highland Yakchew products – yak milk chews, Himalayan puff treats and highland mix. 100% natural, long-lasting dog chews. Free UK delivery.',
  alternates: {
    canonical: 'https://highlanddogchew.co.uk/products',
  },
  openGraph: {
    title: 'Dog Chews & Treats | Highland Yakchew',
