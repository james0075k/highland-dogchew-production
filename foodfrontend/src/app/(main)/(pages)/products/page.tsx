      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <span className="inline-block text-amber-600 text-sm font-semibold tracking-[0.2em] uppercase mb-3">Shop Our Range</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {categories.map((category, index) => (
              <Link
                key={category.href}
                href={category.href}
                className="group relative bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border border-amber-100 hover:border-amber-300 hover:-translate-y-1"
              >
                {/* Image */}
                ...
                <div className="p-5 md:p-6">
                  <h2 className="text-xl md:text-2xl font-bold text-[#2E1F14] mb-2 group-hover:text-amber-700 transition-colors">
                    {category.title}
                  </h2>
                  <p className="text-[#7A5C4F] mb-4 text-sm leading-relaxed">
                    {category.description}
                  </p>
                  <span className="inline-flex items-center gap-2 text-amber-600 font-semibold group-hover:gap-3 transition-all text-sm">
                    Browse Collection
