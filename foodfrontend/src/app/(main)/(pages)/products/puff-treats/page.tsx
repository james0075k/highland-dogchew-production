    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fff8f0] to-[#f3e5d0] dark:from-[#1a1410] dark:to-[#241b16] transition-colors duration-300">
      <section className="pt-[100px] md:pt-[180px] pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          <Link href="/products" className="inline-flex items-center gap-2 mb-8 text-amber-600 dark:text-amber-500 hover:text-amber-700 dark:hover:text-amber-400 font-medium transition-colors">
            <ChevronLeft className="w-5 h-5" />All Products
          </Link>
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2E1F14] dark:text-[#f5e9dc] mb-4">Puff Treats</h1>
          ...
          {error && (
            <div className="py-16 flex items-center justify-center">
              <div className="text-center">
                ...
                <button onClick={fetchProducts} className="px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition">Retry</button>
              </div>
            </div>
          )}
          ...
          {!loading && !error && products.length === 0 && (
            <div className="py-16 text-center">
              <p className="text-[#7A5C4F] dark:text-[#c8b6a6] text-lg">No puff treats found</p>
            </div>
          )}
