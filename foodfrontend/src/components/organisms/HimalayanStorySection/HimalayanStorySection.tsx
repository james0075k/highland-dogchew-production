      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-20 md:mb-32">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="font-antique text-3xl md:text-4xl lg:text-5xl font-bold text-[#2E1F14] mb-6 tracking-[-0.01em]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed">
              Simply microwave the nugget for about 45 seconds until it puffs up (vary the time depending on your microwave power) - Let it <span className="font-bold text-orange-600">COOL</span> - and then watch as your dog enjoys the crunchy texture and delicious smoky taste.
            </p>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div className="pt-1">
                  <p className="text-gray-800 font-semibold">Microwave for 45 seconds</p>
                  <p className="text-gray-600 text-sm">Until it puffs up nicely</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-1">
                  <p className="text-gray-800 font-semibold">Let it cool completely</p>
                  <p className="text-gray-600 text-sm">Safety first for your pup</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="pt-1">
                  <p className="text-gray-800 font-semibold">Watch them enjoy!</p>
                  <p className="text-gray-600 text-sm">Crunchy texture & smoky taste</p>
                </div>
              </div>
            </div>
          </div>
